cask "muffon" do
  ...
  on_arm do
    ...
    url "https://github.com/staniel359/muffon/releases/download/v#{version}/muffon-#{version}-mac-arm64.dmg"
  end

  on_intel do
    sha256 "997b1b48ea32089ecc92ab2020f79193285e815c680c8b35f9994d6dc1477ec5"
    url "https://github.com/staniel359/muffon/releases/download/v#{version}/muffon-#{version}-mac-x64.dmg"
  end
